...
-- Reemplaza a setup-completo.sql (Supabase)
-- Sin dependencias de Supabase Auth, RLS o funciones propietarias
-- ============================================================
...
-- ============================================================
-- 1. TABLA: usuarios (reemplaza auth.users de Supabase)
-- ============================================================
...
-- VERIFICACIÓN
-- ============================================================
SELECT '✅ ESQUEMA ADDBOX COMPLETO PARA NEON' as mensaje,
